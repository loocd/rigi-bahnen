...
var SimpleLightbox = /*#__PURE__*/ (function () {
	function SimpleLightbox(elements, options) {
		...
		_defineProperty(this, "defaultOptions", {
			...
			disableScroll: false,
			alertError: true,
			alertErrorMessage: "Bild nicht gefunden. Nächstes Bild wird geladen",
			additionalHtml: false,
			history: true,
			throttleInterval: 500,
			// throttle: 500ms "Blockierung" nach jedem Wechsel zum nächsten Bild. Ohne die Verzögerung kommt es es bei zu schnellem Wechseln zu Verschiebungen
			doubleTapZoom: 2,
			maxZoom: 2,
